...
interface Props {
  isOpen: boolean,
  createPost: (req: PublicationRequest) => Promise<void>,
}
...
const isCreateAvailable = computed(() => {
  return title.value != "" && description.value != "" && categories.value != ""
})

const CreatePost = async () => {
  if (isCreateAvailable && user.value) {
  ...
  <div class="modal-container" :class="{active: isOpen, 'dark-theme': theme === 'dark'}" @click="handleClose">
    <div class="modal-content" @click.stop>
      ...
      <div class="modal-header">
        ...
        <p>Укажите данные для создания новой публикации</p>
      </div>
